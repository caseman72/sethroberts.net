...
for(var h=$("#quoteBox1").find("p").hide(),g=h.length,I=Math.floor(Math.random()*g--),N=0;4>N;N++)h.eq(I).show(),++I>g&&(I=0);
$("a[href$='.mp3']").each(function(i_not_used, elem) {
	$(elem).before( $(elem).clone().addClass("sm2_button") ).before("&nbsp;");
});
});

/*! SoundManager 2 V2.97a.20131201 | http://schillmania.com/projects/soundmanager2/ */
