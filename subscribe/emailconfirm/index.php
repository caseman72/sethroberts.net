...
<head>
  ...
  <title>Seth Roberts | Subscribe | Confirm your subscription</title>
  <meta name="Description" content="Seth Roberts | Subscribe | Confirm your subscription"/>
  ...
  <div id="contentWrap">
    ...
    <div id="col2">
      ...
      <div id="mainBody" style="height: 280px;">
        ...
        <p>Please check your mailbox for a confirmation request. Follow its instructions to finish signing up.</p>
        <div class="clear"></div>
      </div>
      <div id="footer">
